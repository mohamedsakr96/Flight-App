...
public class PopularDestination extends AppCompatActivity implements DataListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        popularDestinationFragment.setDataListener(this);
        getSupportFragmentManager().beginTransaction().add(R.id.pd_destination_act,popularDestinationFragment,"").commit();
